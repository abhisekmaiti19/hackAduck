        ...
        <div className="row">
          ...
          <div className="col-xs-6 col-md-3">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="https://github.com/abhisekmaiti19/hackAduck">
                  Contribute
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://goo.gl/maps/WEz3axuP8hSxRQ7NA">Location</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-8 col-sm-6 col-xs-12">
            <p className="copyright-text">
              ...
              <a href="#"> Quick Store</a>. Develope with ❤ by{" "}
              <a href="https://abhisekmaiti19.me"> Abhisek Maiti </a>
            </p>
          </div>
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <ul className="social-icons">
              ...
              <li>
                <a className="github" href="https://github.com/abhisekmaiti19">
                  <FaGithub />
                </a>
              </li>
              <li>
